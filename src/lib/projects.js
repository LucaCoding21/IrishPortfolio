    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          videos: [
            {
              embedUrl: "https://player.cloudinary.com/embed/?cloud_name=du4aptrjx&public_id=Comp_2_ezzoow&profile=emdep-website&autoplay=true&controls=false&loop=true",
              title: "Desktop View Video",
              width: "100%",
              maxWidth: 1300,
              aspectRatio: "640 / 360",
            ...
            {
              embedUrl: "https://embed.figma.com/design/Z808jGncRdB8SAdsy4thgT/Emdep-Hi-Fi?node-id=0-1&embed-host=share",
              title: "Desktop View - Figma Prototype",
              width: "100%",
              maxWidth: 1300,
              aspectRatio: "800 / 450",
        ...
        },
        {
          type: "text",
          paragraphs: [
            "Take a closer look at my work in the figma file!",
          ],
          spacing: "mt-12",
        },
        {
          ...
          headingVariant: "accent",
          paragraphs: [
            "Check the low fidelity wireframes here",
          ],
          image: {
        ...
        },
        {
          ...
          videos: [
            {
              embedUrl: "https://embed.figma.com/design/Z808jGncRdB8SAdsy4thgT/Emdep-Hi-Fi?node-id=40-444&embed-host=share",
              title: "Mobile High-Fidelity Wireframes - Figma",
              width: "100%",
              maxWidth: 1300,
              aspectRatio: "800 / 450",
...
const founditFinalSolutionBlocks = [
  ...
  },
  {
    type: "video",
    spacing: "mt-10",
    layoutClass: "grid grid-cols-1 gap-6",
    videos: [
      {
        videoId: "admin-view_3_emut58",
        title: "Foundit admin view walkthrough",
        width: 381,
        height: 780,
        borderRadius: 40,
        aspectRatio: "381 / 780",
        cloudinarySrc:
          "https://res.cloudinary.com/du4aptrjx/video/upload/c_fill,ar_381:780,f_auto,q_auto/admin-view_3_emut58.mp4",
        captionTitle: "admin view",
      },
      {
        videoId: "student-view_iuhfiz",
        title: "Foundit student view walkthrough",
        width: 381,
        height: 780,
        borderRadius: 40,
        aspectRatio: "381 / 780",
        cloudinarySrc:
          "https://res.cloudinary.com/du4aptrjx/video/upload/c_fill,ar_381:780,f_auto,q_auto/student-view_iuhfiz.mp4",
        captionTitle: "Student view",
        playOnView: true,
      },
    ],
  },
      ...
      if (section.id === "solution") {
        ...
        return {
          ...
          blocks: [
            ...
            {
              type: "image",
              src: "/images/fitcheck-data.png",
              alt: "FitCheck Results Data",
              width: 1200,
              height: 600,
