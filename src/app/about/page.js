            ...
            <div className="space-y-6 md:space-y-8 text-center lg:text-left">
              ...
              >
                <p className="text-[21px] md:text-[25px] leading-relaxed text-[#3c3d32] mb-4">
                 {"Hi, I&rsquo;m Claire! I turn \"what if\" ideas into fun, clean designs fueled by curiosity and a little bit of development."}
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center text-center lg:text-left">
            <div className="mx-auto lg:mx-0">
              ...
              <p className="text-[22px] md:text-[25px] leading-relaxed max-w-[560px] mx-auto lg:mx-0 text-[#3c3d32]">
                {"When I&rsquo;m not working, I like exploring new hobbies and revisiting old ones. One hobby that I am revisiting is baking. My only favourite part about baking is being able to share the goodies I make with my friends and family. Their satisfaction encourages me to try new recipes."}
              </p>
